---
title: "如何为自制耗材干燥箱选择控制器"
description: "比较 ESP32、Arduino、RP2040、STM32 和 Klipper MCU 在耗材干燥箱、加热腔、照明、传感器和其他 3D 打印机模块中的使用。"
---

# 如何为自制耗材干燥箱选择控制器

控制器决定耗材干燥箱或加热腔如何控制加热、风扇、照明、传感器以及与打印机的通信。本页帮助你根据简单独立模块、Wi-Fi 设备、Klipper MCU 或可扩展项目选择平台。
