...
PLA é um ótimo material para começar.
...
- suporte de sensor de temperatura em uma peça quente;
- duto de ar diretamente após o aquecedor;
...
Mesmo que a peça não toque o aquecedor, pode estar em ar morno durante longos períodos. Em uma câmara fechada, a temperatura sobe não apenas perto do aquecedor mas em toda.
...
- duto de ar deformado e fluxo através de aquecedor diminuído;
- cobertura de eletrônica empenada e bloqueou ventilação;
...
PLA é útil no início: rapidamente verifique dimensões, ajuste de placa, forma de cobertura, posicionamento de botão ou direção de duto de ar. Mas após verificação, uma peça de trabalho perto de calor frequentemente precisa ser reimpressa de outro material ou substituída por uma peça não-impressa.

## A câmara fechada piora

Em uma sala aberta, uma peça PLA pode parecer estável.

Em uma câmara de secador ou impressora fechada, as condições são diferentes:
...
- PC ou PA/nylon - para usuários experientes e condições mais exigentes;
- metal, fibra de vidro, cerâmica ou suportes prontos - perto do aquecedor e seção de energia.

Se a questão é suporte de aquecedor, proteção térmica, terminais de rede ou sensor crítico, não escolha material de uma lista de filamento apenas. Às vezes a resposta certa é não imprimir esta peça de plástico de todo.
...
- colocando duto de ar PLA diretamente após o aquecedor;
- montando termistor com PLA em uma zona quente;
...
- não reimprimir o protótipo em um material de trabalho.
...
- PLA pode ser utilizado longe de calor e seção de energia.
- Para peças de trabalho perto de calor, considere PETG, ABS/ASA ou solução não-plástica.
- Se falha de uma peça PLA pode afetar segurança, o material é escolhido errado.
