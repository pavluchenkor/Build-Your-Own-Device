...
Em dispositivos em torno de um secador, câmara de impressora ou aquecedor, a escolha do material afeta a segurança. Uma peça pode parecer normal após impressão, mas após uma hora em um invólucro morno pode começar a amolecer, deformar o duto de ar, soltar fixadores ou deslocar um sensor.
