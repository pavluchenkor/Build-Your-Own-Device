...
![Ponte térmica clássica através de um gabinete](../../img/04-thermal-physics-and-materials/02-thermal-bridge-classic.png)
...
- como radiador para eletrônica de potência;
- como superfície interna não inflamável.

Mas o metal não torna um dispositivo seguro automaticamente. Se uma placa de metal toca uma zona quente e o gabinete externo, pode direcionar o calor para o exterior. Se o plástico for parafusado a ela, esse plástico pode aquecer através do fixador. Se os fios passarem através dele, perto da borda você precisa de entradas de fios, proteção contra fricção e margem de temperatura para isolamento.

## Isolamento: Perda Menor, Maior Responsabilidade

O isolamento reduz a perda de calor, mas não elimina o controle de temperatura.
...
- falha do ventoinha ou interruptor travado torna-se mais perigoso.
...
- não direccione fluxo quente diretamente para plástico;
...
6. Verifique o modo de falha do ventoinha se o aquecedor depende do fluxo de ar.
