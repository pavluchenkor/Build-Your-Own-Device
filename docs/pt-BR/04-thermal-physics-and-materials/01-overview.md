...
Esta seção é necessária para dispositivos com aquecedor, câmara, secador de filamento, filtro com ar quente, dutos de ar, ventoinhas, isolamento ou peças impressas próximas de temperaturas altas.

Você não encontrará aqui um curso acadêmico de física. O objetivo é prático: entender para onde o calor vai, por que o gabinete aquece de forma desigual e por que um material serve para a parede da câmara enquanto outro pode amolecer, emitir fumaça ou se tornar risco de incêndio.
...
- o que acontece se a ventoinha falhar;
...
Um dispositivo pode mostrar `45°C` na tela, mas perto do aquecedor, de um terminal ou dentro do duto de ar a temperatura pode ser muito maior. Por isso, não importa apenas a temperatura-alvo da câmara, mas também a temperatura local das peças.
...
**Condução térmica** - o calor passa através de um material. Por exemplo, um suporte metálico transfere rapidamente calor de uma zona quente para o gabinete.

**Convecção** - o calor é transportado pelo fluxo de ar. Por exemplo, uma ventoinha retira calor do aquecedor e o espalha pela câmara.
...
O material do gabinete, parede, duto de ar ou suporte afeta o regime térmico.
...
- conduz mal o calor;
- pode ser conveniente para um gabinete;
...
Iniciantes muitas vezes olham apenas para a temperatura de fusão. Isso é um erro.
...
- perder resistência;
- começar a cheirar;
- liberar produtos de decomposição;
- tornar-se mais inflamável.

Para gabinete, suporte ou duto de ar, a temperatura de trabalho permitida, a temperatura de amolecimento, as propriedades contra fogo e as recomendações do fabricante importam mais.

## O ar precisa se mover corretamente

A ventoinha em um dispositivo aquecido não está ali "para enfeitar". Ela determina como o calor sai do aquecedor.
...
- o controle PID se comporta pior.

Mas a ventoinha também precisa ser escolhida e instalada corretamente: fluxo, pressão estática, direção, filtro, tela e duto de ar podem mudar completamente o resultado.
...
- temperatura do gabinete e das peças impressas;
...
O primeiro teste deve ser feito sob observação e com possibilidade de desligar a energia rapidamente.
...
Um dispositivo aquecido não é apenas aquecedor e sensor. É um sistema térmico: aquecedor, ar, gabinete, materiais, fios, terminais, ventoinha, sensores e proteção de emergência.
