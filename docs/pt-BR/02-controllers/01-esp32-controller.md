...
- [Arduino-ESP32: LED Control API](https://docs.espressif.com/projects/arduino-esp32/en/latest/api/ledc.html) — PWM/LEDC em Arduino-ESP32 para ventoinhaes, iluminação de fundo e outros sinais PWM.
