...
1. Aprender o modelo exato da placa.
2. Aprender o microcontrolador exato.
...
6. Escolher o método de gravação correto.
7. Compilar ou baixar o arquivo correto.
8. Colocar a placa em modo de gravação.
9. Gravar o firmware.
10. Verificar se a placa aparece no sistema.
11. Verificar a comunicação com o host e pinos básicos sem carga.
...
- foto das conexões;
- diagrama de pinos;
- configurações `make menuconfig`;
- link para instruções do fabricante.
...
- gravar arquivo de placa semelhante mas diferente;
...
- conectar carga de potência antes de verificar pinos;
