---
title: "Почему PLA опасен для горячих корпусов и сушилок"
description: "Почему PLA плохо подходит для деталей рядом с нагревателем, сушилкой филамента или активной термокамерой: температура размягчения, деформация и риски."
---

# Почему PLA опасен для горячих корпусов и сушилок

PLA удобен для быстрых прототипов, но плохо подходит для деталей, которые работают рядом с нагревателем или внутри тёплой камеры. Эта страница объясняет, где PLA начинает деформироваться и когда лучше выбрать PETG, ABS, ASA или более термостойкий материал.
