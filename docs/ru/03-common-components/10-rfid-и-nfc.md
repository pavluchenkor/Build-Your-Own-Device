...
Подробное подключение RC522 по SPI показано в практическом разделе: [Подключение RFID-считывателя](../06-практические-инструкции/05-подключение-rfid-считывателя.md).
