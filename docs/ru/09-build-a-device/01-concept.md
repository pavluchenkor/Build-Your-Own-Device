...
6. [Управление нагревом](07-heating-control.md) — логика поддержания температуры, вентилятор, команды портала.
7. [Сборка и проверка](08-assembly-and-check.md) — финальная сборка, первый прогрев, чеклист безопасности.

!!! tip "Готовый пример"
    Если хотите сразу увидеть результат — законченный проект лежит в `docs/example/09-cabinet/` и собирается командой `pio run -e cabinet`. Главы ниже разбирают этот же код по шагам.
