...
!!! warning "Печатные детали рядом с нагревом"
    PLA размягчается при температуре, которая легко находится рядом с нагревателем. Детали возле тепла печатайте из термостойкого материала. См. [Термостойкие материалы](../07-3d-printing/04-heat-resistant-materials.md) и [Почему PLA — рискованный выбор](../07-3d-printing/06-why-pla-is-risky.md).
