...
![Écran d'un oscilloscope numérique](../../../img/04-tools/07-digital-oscilloscope.jpg)
...
![Animation de PWM : changement du cycle de travail et forme d'onde du signal](../../../img/04-tools/07-pwm-signal-waveform.gif)
