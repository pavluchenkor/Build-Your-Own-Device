...
Esta secção não é sobre recolha de ferramentas.

É sobre o conjunto mínimo que ajuda você a montar com segurança um dispositivo, verificar ligações e encontrar erros simples sem adivinhar.
...
- verificar continuidade num fio;
- testar um termistor;
...
Nem tudo precisa ser comprado de uma vez. Mas um multímetro e ferramentas apropriadas de fio geralmente pagam por si mesmas rapidamente.
...
1. Compreender o que deve ser ligado.
...
- `03-usb-ttl-adapter.md` - adaptadores USB-UART, TX/RX/GND, níveis lógicos 3.3V/5V, programação e registos.
...
## O que vale a pena comprar correctamente

Há coisas que não deve economizar:

- um multímetro com sondas apropriadas e modo de continuidade;
- um ferro de solda com controlo de temperatura;
...
- medir resistência num circuito energizado;
...
- pensar que se um fio "segura", o contacto é bom.

## Os essenciais

- Multímetro é a primeira ferramenta de diagnóstico.
- USB-UART é necessário para registos, programação e comunicação com dispositivos UART.
...
- Para a parte de alimentação, qualidade de contacto, bitola de fio e segurança importam mais do que a aparência da montagem.
