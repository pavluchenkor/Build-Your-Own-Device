...
- [Prusa Knowledge Base: PLA](https://help.prusa3d.com/article/pla_2062) - PLA jako jednoduchý materiál pro prototypy a součásti bez vysokého mechanického, chemického nebo teplotního zatížení.
- [Stránka produktu Prusa PLA](https://www.prusa3d.com/en/product/pla-filament/) - praktické varování týkající se nízké teplotní odolnosti a ztráty pevnosti při teplotách nad přibližně 60°C.
- [Bambu Lab: Průvodce filamentem PLA](https://bambulab.com/en-us/filament/pla) - PLA jako materiál pro začátečníky na dekorativní části a modely, nikoli však pro vysoké teploty a náročné aplikace.
- [Bambu Lab: Průvodce porovnáním filamentu 3D tiskárny](https://bambulab.com/en-us/filament-guide) - porovnání teplotní odolnosti a dalších vlastností PLA, PETG, ABS, ASA, PC a inženýrských materiálů.
- [Filwiz: Odolnost PLA vůči teplu vysvětlena](https://filwiz.com/guides/pla-heat-resistance-glass-transition-vs-melting-point) - vysvětlení rozdílu mezi teplotou tání, sklenou přechodem a praktickou teplotní tolerancí PLA.
